...
public class E03MathClass extends Object {
	...
	public static void main(String[] args) {
		...
		System.out.println("Math.round:"+ Math.round(3.49999));//버림 
		System.out.println("Math.round:"+ Math.round(3.54444));//올림
		System.out.println("Math.round:"+ Math.round(-1.4));
		System.out.println("Math.round:"+ Math.round(-1.5));//왜 -1인지기억이안남
