...
//과일 상자 :Object기반으로 모든 객체(과일)를 저장할수있는 클래스
class FruitBox {
	Object item;
...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 * FruitBox fBox2=new FruitBox("당도가 30인오렌지"); Orange
		 * orange4=(Orange)fBox2.pullOut();//<=런타임에러 발생한다. 
		 * orange4.showInfo();
		 */
	}
