 ...
 */
	public static void main(String[] args) {
		/*
		만약 아래와 같이 타입매개변수 부분을 생략하거나 Object로 설정하면 모든객체를
		저장할수잇는 컬렉션을 정의 할 수 있다. 
		...
		list.add("트오ㅏ이스");
		list.add(3,"워너원");
		//list.add(5,"소방차 ㅋㅋ");//에러발생(인덱스를 건너뛸수는없다.)
		...
		1-6] 포함여부확인
				...
				반환한다. 위치한 인덱스까지는 확인할수 없다. 
		 */
		System.out.println(list.contains("빅뱅")?"빅뱅있음":"빅뱅없음");
		System.out.println(list.contains("블랭핑크")?"블랭핑크있음":"블랙핑크없음");
		System.out.println("\n====================");
		/*
		 * 1-7] 삭제
		 * 방법1 : 인덱스로 삭제하기 . 
